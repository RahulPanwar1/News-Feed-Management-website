...
<html lang="en">
  <head>
    ...
    <style type="text/css">
    body{background-image:url('academics6.jpg');
      background-repeat:no-repeat;
      background-size:100% 75%;
      
    }
    </style>
    <title> IITDM JABALPUR NEWS PORTAL</title>
  </head>
...
<nav class="navbar navbar-expand-lg navbar-light " style="background-color: blue;padding:10px;">
      ...
      <li style = "text-align:center;color:white"><b>IIITDM STUDENTS GET THEIR DREAM JOB IN SILICON VALLEY USA</b></li>
      ...
      <?php
        $query="SELECT * FROM detail WHERE category='academics'";
